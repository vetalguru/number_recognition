...
#ifndef LIB_INCLUDE_NEURON_H
#define LIB_INCLUDE_NEURON_H

#include <vector>

class Neuron {
    public:
        Neuron(int aNumInputs);
        ...
        void updateWeights(const std::vector<double>& aInputs, double aLearningRate, double delta);
